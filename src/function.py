...
def restart_game():
    """promazání proměnných z lib.py, restart hry"""
    lib.parties.clear()
    ...
    lib.player_history.clear()
    for variable in lib.game_variables:
        lib.game_variables[variable] = 0
